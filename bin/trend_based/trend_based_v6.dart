...
class Reporter {
  ...
  static void banner() {
    print('''
╔══════════════════════════════════════════════════════════════════════════════╗
║   CRYPTO TREND-FOLLOWING · WALK-FORWARD OPTIMIZER v6                         ║
║   v3 base + daily EMA slope gate (long only when EMA20 rising, vice versa)   ║
...
''');
  ...
  static void exportCsv(
    ...
    final lb = File('$outDir/leaderboard_v6.csv');
    ...
    final tr = File('$outDir/all_trades_v6.csv');
    ...
    final wb = File('$outDir/window_breakdown_v6.csv');
    ...
    print('  📄 leaderboard_v6.csv');
    print('  📄 all_trades_v6.csv');
    print('  📄 window_breakdown_v6.csv');
...
void main(List<String> args) {
  ...
  final outDir = args.length > 1 ? args[1] : './wf_results_v6';
