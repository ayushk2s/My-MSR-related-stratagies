...
class BacktestConfig {
  ...
  // Evidence: July is consistently negative across ADA, SOL, SOL, XRP, TRX.
...
void main() {
  final config = BacktestConfig(
    csvPath:           '/Users/ayush/Desktop/candlestick data/5m/BNBUSDT5m.csv',
    symbol:            'SOLUSDT',
    sfiPeriod:         10,
    sfiMultiplier:     1.7,
    ...
    // v1 evidence: 04 WR 12.5%, 11 WR 10.5%, 13 WR 26.8% — combined -$5,573 loss
    // v2 evidence: 05 0.0% WR -$534, 14 0.0% WR -$470, 11 0.0% WR -$292
    ...
    // ── Calendar / month filter ─────────────────────────────────────────────
    // July consistently negative: SOL -609, SOL -655, ADA -221, XRP -341
    blockMonths: const [7],
    ...
    // ── Min stop distance filter (NEW in v2) ────────────────────────────────
    // Only trade when zone boundary is >0.7% away from entry.
    // Wide stops = price touched deep into zone = stronger conviction.
    // v1 result: 13 trades >0.7% had 53.8% WR +$1785 vs 24 trades 0.3-0.7% had 37.5% WR -$462.
    minStopDistPct: 0.7,
  );
